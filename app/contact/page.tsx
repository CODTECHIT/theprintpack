...
Please let me know the next steps.`;
  ...
  return (
    <main className="bg-[#F5F5F0] min-h-screen text-[#2B2B2B]">
      ...
      <section className="relative min-h-[40vh] md:min-h-[50vh] flex items-center justify-center pt-24 pb-8 md:pt-32 md:pb-20 overflow-hidden">
        {/* Background Overlay */}
      ...
      {/* Premium FAQ Section */}
      <section className="py-12 md:py-32 bg-[#F9F9F4]">
        <div className="container max-w-7xl mx-auto px-6">
          <ScrollReveal>

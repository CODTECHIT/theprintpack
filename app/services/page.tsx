          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {services.map((service, index) => (
              <div
                ...
                className="group bg-white rounded-[48px] overflow-hidden border border-[#E8E8E3] transition-all duration-500 hover:shadow-2xl hover:shadow-[#2E7D32]/10 hover:-translate-y-2"
              >
                {/* Image Holder */}
                ...
                <div className="p-10 space-y-8">
                  ...
                  <div className="space-y-4 pt-4 border-t border-[#F0F0E8]">
                  ...
                  <button
                    ...
                    className="w-full py-5 bg-[#F5F5F0] text-[#2E7D32] rounded-2xl font-bold border border-transparent hover:bg-[#2E7D32] hover:text-white transition-all duration-300 active:scale-95 group/btn overflow-hidden relative"
                  >

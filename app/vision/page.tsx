...
export default function Vision() {
    ...
    return (
        <main className="bg-white min-h-screen text-[#1A1A1A]">
            ...
            <div className="pt-40 pb-20 container max-w-4xl mx-auto px-6 space-y-24">
                ...
                <div className="pt-20 border-t border-[#E8E8E3]">
                    <div className="bg-[#F9FAF5] rounded-[40px] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8">
